  ...
  return (
    <ThemeProvider>
      <main className="grid min-h-screen place-items-center bg-muted px-4">
        <section className="w-full max-w-md rounded-[2rem] border border-border bg-card p-8 shadow-[var(--marketing-shadow)]">
          <Link href="/" className="mb-8 block text-center text-xl font-bold text-foreground">FidelOS HRMS</Link>
